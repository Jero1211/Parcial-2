...
def verificar_potencia(num1, num2):
    if num2 == 0:
        raise ValueError("No se puede elevar un número a la potencia de cero.")
...
def realizar_operacion(operacion):
    try:
        ...
        if operacion == "suma":
            ...
            verificar_division(num2)  # Verifica si se puede dividir
            resultado = num1 / num2
        elif operacion == "potencia":
            verificar_potencia(num1, num2)  # Verifica si el exponente es cero
            resultado = num1 ** num2
